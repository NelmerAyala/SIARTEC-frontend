      ...
      <div className="w-1/3 bg-white rounded shadow-lg p-8 m-4">
        ...
        <form className="mb-4 md:flex md:flex-wrap md:justify-between">
          <div className="flex flex-col mb-4 md:w-full">
            <Label className="mb-2 font-bold text-grey-darkest" htmlFor="email">
              Correo Electónico
            </Label>
            <input className="border py-2 px-3 text-grey-darkest" type="email" name="email" id="email" />
          </div>
          <div className="flex flex-col mb-6 md:w-full">
            <Label className="mb-2 font-bold text-grey-darkest" htmlFor="password">
              Contraseña
            </Label>
            <input className="border py-2 px-3 text-grey-darkest" type="password" name="password" id="password" />
          </div>
          <div className="flex items-center justify-between">
            <Button type="submit" className="w-full mt-6 bg-red-600 rounded-full hover:bg-red-700 text-white-">
              Iniciar Sesión
            </Button>
          </div>
          <div className="flex items-center justify-between">
